...
#define SWIG_init    boot_key_utils

#define SWIG_name   "key_utilsc::boot_key_utils"
#define SWIG_prefix "key_utilsc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_key_utils_var::
class _wrap_key_utils_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
{"key_utilsc::generatePem", _wrap_generatePem},
{"key_utilsc::generateSinFromPem", _wrap_generateSinFromPem},
{"key_utilsc::getPublicKeyFromPem", _wrap_getPublicKeyFromPem},
{"key_utilsc::signMessageWithPem", _wrap_signMessageWithPem},
{"key_utilsc::mysignMessageWithPem", _wrap_mysignMessageWithPem},
{"key_utilsc::mygeneratePem", _wrap_mygeneratePem},
{"key_utilsc::mygenerateSinFromPem", _wrap_mygenerateSinFromPem},
{"key_utilsc::mygetPublicKeyFromPem", _wrap_mygetPublicKeyFromPem},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
